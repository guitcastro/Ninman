...
${OBJECTDIR}/NinmanConfig.o: NinmanConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/NinmanConfig.o NinmanConfig.cpp
...
${OBJECTDIR}/Ninman.o: Ninman.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Ninman.o Ninman.cpp

${OBJECTDIR}/Ghost.o: Ghost.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Ghost.o Ghost.cpp
...
${OBJECTDIR}/NinmanMenu.o: NinmanMenu.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/NinmanMenu.o NinmanMenu.cpp

${OBJECTDIR}/NinmanGameGraph.o: NinmanGameGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/NinmanGameGraph.o NinmanGameGraph.cpp
